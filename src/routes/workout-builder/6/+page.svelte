  ...
  onMount(() => {
    ...
    try {
      (window as any).fitgenieWorkoutBuilderStorage?.bindTextarea({
        textareaId: 'structure',
        responseKey: 'routinePreference',
        questionText: 'Do you prefer structured workouts or more flexibility in your routine?',
        stepNumber: 6,
        saveOnIds: ['finish']
      });
    } catch (e) {
      console.error('Failed to initialize workout builder storage binding (step 6):', e);
    }
  });
</script>
        ...
        <div class="flex w-full max-w-[640px] flex-col gap-10">
          ...
          <div class="flex flex-col gap-3">
            <div class="flex items-end justify-between px-1">
              ...
              <span class="text-sm font-bold text-text-main dark:text-text-light">100%</span>
            </div>
            <div
          ...
          <div class="flex flex-col gap-4">
            ...
            >
              Do you prefer structured workouts or more flexibility in your routine?
            </h1>
            <p class="text-lg font-normal leading-relaxed text-muted-light dark:text-muted-dark">
              This helps decide whether you should follow a phased plan or a more adaptable approach.
            </p>
          </div>
          <!-- Input Section -->
          <div class="flex flex-col gap-6">
            <div class="relative group">
              <label class="sr-only" for="structure">Your preference response</label>
              <div
              ...
              <textarea
                ...
                id="structure"
                placeholder="- I prefer a structured plan with clear progression.
- I like flexibility and variety in my workouts."
              ></textarea>
              <p class="mt-3 text-sm text-muted-light dark:text-muted-dark px-2">
                ...
                If you like structure, we can use a phased progression over time.
              </p>
            </div>
            <!-- Action Buttons -->
            <div class="flex flex-col items-center justify-between gap-4 pt-4 sm:flex-row">
              ...
              <a
                id="finish"
                href="/workout-builder/processing"
