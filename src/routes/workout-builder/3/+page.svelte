<script lang="ts">
  ...
  onMount(() => {
    ...
    try {
      ...
      console.error('Failed to initialize workout builder storage binding (step 3):', e);
    }
  });
</script>
        ...
        <div class="flex w-full max-w-[640px] flex-col gap-10">
          ...
          <div class="flex flex-col gap-3">
            <div class="flex items-end justify-between px-1">
              ...
              <span class="text-sm font-bold text-text-main dark:text-text-light">50%</span>
            </div>
            <div
          ...
          <div class="flex flex-col gap-4">
            ...
            <p class="text-lg font-normal leading-relaxed text-muted-light dark:text-muted-dark">
              We’ll avoid movements that could aggravate pain and adjust exercise selection accordingly.
            </p>
          </div>
          <!-- Input Section -->
          <div class="flex flex-col gap-6">
            <div class="relative group">
              <label class="sr-only" for="limitations">Your limitations response</label>
              <div
              ...
              <textarea
                ...
                id="limitations"
                placeholder="- No injuries or limitations.
- Yes, I have back pain.
- Yes, I have a leg injury.
- Yes, I have another injury or limitation (please specify)."
              ></textarea>
              <p class="mt-3 text-sm text-muted-light dark:text-muted-dark px-2">
                ...
                If you select “other”, please include details (what, where, and what movements hurt).
              </p>
            </div>
            <!-- Action Buttons -->
